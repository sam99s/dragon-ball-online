    ...
    $(dbz).click(() => {
        ...
        <div id="removerDBZ">
            ...
            <div class="container-fluid dragonBallZ-contenido d-flex">
                ...
                <div class="col-2 d-block" id="botonesZ">
                    ...
                    <button type="button" id="botonesZ1" class="btn saiyan">Saiyan</button>
                    <button type="button" id="botonesZ2" class="btn freezer">Freezer</button>
                    <button type="button" id="botonesZ3" class="btn androide">Androide</button>
                    <button type="button" id="botonesZ4" class="btn cell">Cell</button>
                    <button type="button" id="botonesZ5" class="btn otroMundo">Otro Mundo</button>
                    <button type="button" id="botonesZ6" class="btn majinBoo">Majin Boo</button>
                    <button type="button" id="botonesZ7" class="btn fusion">Fusion</button>
                    <button type="button" id="botonesZ8" class="btn final">Final</button>
                </div>
        ...
        function cambiarFondo(e){
            ...
            switch(btnFondo){
                ...
                default:
                    alert('Apretaste fuera del boton👀');
                    break
