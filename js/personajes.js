$(document).ready(function () {
    const goku = $('#goku');
    const bulma = $('#bulma');
    const krillin = $('#krillin');
    const roshi = $('#roshi');
    const jackiechun = $('#jackiechun');
    const urigame = $('#urigame');
    const yamcha = $('#yamcha');
    const oolong = $('#oolong');
    const puar = $('#puar');
    const tenshinhan = $('#tenshinhan');
    const chaoz = $('#chaoz');
    const shenlong = $('#shenlong');
    const namu = $('#namu');
    const chichi = $('#chichi');
    const yajirobe = $('#yajirobe');
    const songohan = $('#songohan');
    const piccolodaimao = $('#piccolodaimao');
    const piccolo = $('#piccolo');
    const tambourine = $('#tambourine');
    const reychapa = $('#reychapa');
    const taopaipai = $('#taopaipai');
    const ninjapurpura = $('#ninjapurpura');
    const octavio = $('#octavio');
    const comandantered = $('#comandantered');
    const mayorblack = $('#mayorblack');
    const generalblue = $('#generalblue');
    const generalwhite = $('#generalwhite');
    const sargentometalico = $('#sargentometalico');
    const kamisama = $('#kamisama');
    const anunciador = $('#anunciador');
    const bora= $('#bora');
    const barrykahn = $('#barrykahn');
    const uranaibaba = $('#uranaibaba');
